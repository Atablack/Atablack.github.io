...
console.log('пароль король орел');
let dropdownFo = () => {
    ...
    if (fo.classList.toggle('.fo')) {
        ...
        text4.innerHTML = 'Каждое изделие, созданное нами, уникально. Мы гордимся индивидуальными деталями и ручной работой, что делает каждое изделие особенным и неповторимым.'
